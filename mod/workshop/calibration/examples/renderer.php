 ...
 */
class workshopcalibration_examples_renderer extends plugin_renderer_base {
    
    protected function render_workshop_examples_calibration_explanation(workshop_examples_calibration_explanation $explanation) {
        
        if (isset($explanation->empty)) {
            return $this->output->heading(get_string("noexamples", "workshopcalibration_examples"));
        }
        ...
        $accuracy_curve = workshop_examples_calibration_method::$grading_curves[$explanation->accuracy];
        ...
        $consistency_curve = workshop_examples_calibration_method::$grading_curves[9 - $explanation->consistency];
